...
object PreviewUtil {
    val noteSamples = listOf(
        // SHORT CONTENT (under 50 characters)
        NoteSample(
        ...
        // MEDIUM CONTENT (50-200 characters)
        NoteSample(
            date = "2025-06-17T11:20:00Z",
            title = "Daily Journal",
        ...
        // LONG CONTENT (200+ characters - will be truncated)
        NoteSample(
            date = "2025-06-13T12:30:00Z",
